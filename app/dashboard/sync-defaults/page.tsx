...
export default function SyncDefaultsPage() {
        ...
        <div className="p-8 max-w-7xl mx-auto min-h-screen text-white relative z-0">
            <div className="flex flex-col mb-10 gap-4">
                ...
                <div className="flex justify-between items-end">
                    <div>
                        <h1 className="text-4xl font-extralight tracking-wider">SZINKRON <span className="text-gold font-bold glow-text">ALAPÉRTELMEZÉSEK</span></h1>
                        <p className="text-gray-400 text-sm font-light mt-2">
                            Itt állíthatod be, hogy a szervezőkhöz tartozó új események alapértelmezésként hova szinkronizáljanak be.
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div className="relative z-0">
                <DefaultSyncLocationsTable readonly={!canManage} />
            </div>
        </div>
    );
}
