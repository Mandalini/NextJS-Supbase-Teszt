        ...
        <div className="p-8 max-w-6xl mx-auto min-h-screen text-white">
            <div className="flex flex-col sm:flex-row justify-between items-center mb-10 gap-4">
                ...
                <div className="flex items-center gap-4">
                    <div className="hidden sm:flex items-center gap-6 text-sm text-gray-400 pr-5 border-r border-white/10 h-10">
                        <Link href="/" className="px-4 py-1.5 rounded-full border border-brand-blue/30 text-brand-blue hover:bg-brand-blue/10 text-xs uppercase tracking-widest transition-colors font-bold shadow-[0_0_10px_var(--color-brand-blue)]/20">
                            &larr; Kezdőlap
                        </Link>
